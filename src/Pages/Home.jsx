...
const SOCIAL_LINKS = [
  {
    icon: Github,
    link: "https://github.com/affandi25",
    label: "GitHub Profile",
  },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/muhammadyusufaffandi/",
    label: "LinkedIn Profile",
  },
  {
    icon: Instagram,
    link: "https://www.instagram.com/__ffndiii__/",
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Muhammad yusuf affandi — Frontend Web Developer</title>
        <meta
          name="description"
          content="Website resmi Muhammad yusuf affandi, Front-End Web Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://muhammadyusufaffandi.com" />
        <meta
          property="og:title"
          content="Muhammad yusuf affandi — Frontend Web Developer"
        />
        <meta
          property="og:description"
          content="Website resmi dan portofolio Muhammad yusuf affandi, Front-End Web Developer."
        />
        <meta property="og:url" content="https://muhammadyusufaffandi.com" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json">{`
          {
            "@context": "https://schema.org",
            "@type": "Person",
            "name": "Muhammad yusuf affandi",
            "jobTitle": "Frontend Developer",
            "url": "https://muhammadyusufaffandi.com",
            "sameAs": [
              "https://github.com/muhammadyusufaffandi",
              "https://www.linkedin.com/in/muhammadyusufaffandi/",
              "https://www.instagram.com/muhammadyusufaffandi/"
            ]
          }
        `}</script>
      </Helmet>
              ...
              >
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p
                    ...
                    data-aos-delay="1000"
                  >
                    fokus pada pengembangan perangkat berbasis mikrokontroler
                    dan Internet of Things (IoT), serta memberikan solusi
